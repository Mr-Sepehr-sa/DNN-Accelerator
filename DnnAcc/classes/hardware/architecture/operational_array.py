...
from DnnAcc.classes.hardware.architecture.operand_spatial_sharing import OperandSpatialSharing
from DnnAcc.classes.hardware.architecture.operational_unit import OperationalUnit, Multiplier
