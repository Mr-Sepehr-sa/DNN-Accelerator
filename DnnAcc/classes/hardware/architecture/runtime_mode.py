from DnnAcc.classes.hardware.architecture.operational_array import OperationalArray
...
if __name__ == "__main__":
    from DnnAcc.classes.hardware.architecture.operational_array import multiplier_array_example1, multiplier_array_example2, OperationalArray
    from DnnAcc.classes.hardware.architecture.memory_hierarchy import memory_hierarchy_example1, memory_hierarchy_example2
