...
from DnnAcc.classes.mapping.combined_mapping import Mapping
from DnnAcc.classes.mapping.combined_mapping import FourWayDataMoving
from DnnAcc.classes.workload.layer_node import LayerNode
from DnnAcc.utils import pickle_deepcopy
...
class CostModelEvaluation:
    """
    Class that stores inputs and runs them through the DnnAcc cost model.
    """
