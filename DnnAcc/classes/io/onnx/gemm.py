from DnnAcc.classes.io.onnx.parser import Parser
from DnnAcc.classes.io.onnx.utils import get_node_input_output_dimension_shapes, get_attribute_ints_with_name
...
class GemmParser(Parser):
    ...
    def generate_layer_node_for_gemm(self):
        ...
        # If the batch size is 0, we discard it by setting it to 1 internally inside DnnAcc
