...
class AcceleratorParser:
    ...
    def __init__(self, accelerator) -> None:
        ...
        self.supported_accelerators = {
            "ascend": "DnnAcc.inputs.examples.hardware.Ascend_like",
            "edge-tpu": "DnnAcc.inputs.examples.hardware.Edge_TPU_like",
            "eyeriss": "DnnAcc.inputs.examples.hardware.Eyeriss_like",
            "meta-prototype": "DnnAcc.inputs.examples.hardware.Meta_prototype",
            "tesla-npu": "DnnAcc.inputs.examples.hardware.Tesla_NPU_like",
            "tpu": "DnnAcc.inputs.examples.hardware.TPU_like"
        }
